...
setlocal ENABLEDELAYEDEXPANSION
    ...
    set "exeName=v.exe"
    set "compilerFlags=-W4 -WX -Od -nologo -std:c++20 -Zc:strictStrings -GR- -cgthreads8 -MP /EHsc"
    ...
    pushd build
        ...
        @rem Compilation
        cl %compilerFlags% %ignoreWarnings% -I %includeDirs% ..\src\platform_win32.cpp -Fe..\%exeName% -link %linkerFlags% ..\lib\*.lib user32.lib gdi32.lib
